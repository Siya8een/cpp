// WAP to enter record of five students, which contain feilds like roll No.,name,CGP, semister

// (a) list of all the students having CGPI greter than k
// (b) insert a new record of all students at Kth position and print th final record
#include <iostream>
using namespace std;
...
int main()
{
    ...
    cin >> l;
    student *info = (struct student *)malloc((l) * sizeof(struct student));
    ...
    info = (struct student *)realloc(info, (k + 1) * sizeof(struct student));
    if (k < l)
    {
